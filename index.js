function message_box(username , message){
...
var url = 'https://chat-app2-b59ab.firebaseio.com/messages.json?print=pretty';
  class MEME_CHAT{
    home(){
    ...
    create_title(){
      ...
      title.textContent = 'ChatApp with RestAPI'
    ...
    create_join_form(){
      ...
      join_input.placeholder = '..Enter Your Name .. Max lenght 15'
    ...
    refresh_chat(){
      ...
      var obkeys = Object.keys(data)
          for (const [key, value] of Object.entries(data)) {
            //   console.table(value.sender , value.message)
            message_box(value.sender , value.message );
